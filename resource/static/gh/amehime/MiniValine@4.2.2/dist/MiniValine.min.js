...
t.removeEventListener?t.removeEventListener(e,n,i||!1):t.detachEvent?t.detachEvent("on".concat(e),n):t["on".concat(e)]=null}};e.exports=i},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.VERSION="4.2.2",t.GBUrl="https://gravatar.loli.net/avatar/",t.EUrl=['https://res.onlyzyx.com/static/npm/alus@latest','https://res.onlyzyx.com/static/gh/MiniValine/qq@master','https://res.onlyzyx.com/static/gh/MiniValine/Bilibilis@master','https://res.onlyzyx.com/static/gh/MiniValine/tieba@master','https://res.onlyzyx.com/static/gh/MiniValine/twemoji@master','https://res.onlyzyx.com/static/gh/MiniValine/weibo@master',],t.pf="https://cdn.polyfill.io/v3/polyfill.min.js?features=es6",t.i18nUrl="https://res.onlyzyx.com/static/gh/MiniValine/minivaline-i18n@latest/",t.DEHash="9e63c80900d106cbbec5a9f4ea433a3e",t.MaxNL=6,t.PS=6,t.C={ip:"",comment:"",rid:"",pid:"",at:"",nick:"",mail:"",mailMd5:"",link:"",ua:navigator.userAgent,url:location.pathname}},function(e,t,n){"use strict";var i=function(e){var t,n=[];for(t in e)
...
e.exports=function(e){var t;1<arguments.length&&void 0!==arguments[1]&&arguments[1]?(t=[],window.autosize||t.push("npm/autosize@5.0.1/dist/autosize.min.js"),window.filterXSS||t.push("npm/xss@1.0.11/dist/xss.min.js"),e.config.closeUA||window.UAParser||t.push("npm/ua-parser-js@1.0.2/dist/ua-parser.min.j"),!e.math&&void 0!==e.config.math||"undefined"!=typeof MathJax||t.push("npm/mathjax@3.2.1/es5/tex-svg.js"),!e.md&&void 0!==e.config.md||window.marked||t.push("npm/marked@1.2.0/lib/marked.min.js"),(0,i.default)("https://res.onlyzyx.com/static/combine/third/valine/parse.js",(function(){e.initBody(),window.MV.scriptEle=!0}),1==window.MV.scriptEle||0==t.length)):(e.config.NoRecordIP||(void 0===window.MV.ip?(0,a.default)(e):e.C.ip=window.MV.ip),t=[],window.md5||t.push("npm/blueimp-md5@2.18.0/js/md5.min.js"),window.AV||t.push("npm/leancloud-storage@4.12.2/dist/av-min.js"),(0,i.default)("https://res.onlyzyx.com/static/combine/third/valine/parse.min.js",(function(){e.initCheck(),window.MV.scriptInit=!0}),1==window.MV.scriptInit||0==t.length))}},function(module,exports,__webpack_require__){"use strict";var _ajax=__webpack_require__(2),_ajax2=_interopRequireDefault(_ajax);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}
