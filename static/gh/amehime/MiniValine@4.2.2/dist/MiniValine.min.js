!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define("MiniValine",[],t):"object"==typeof exports?exports.MiniValine=t():e.MiniValine=t()}(window,(function(){window.regfunc=function(f){window['f'+f]=function(l){console.log(l)
    ...
    e.exports=function(e){var t;1<arguments.length&&void 0!==arguments[1]&&arguments[1]?(0,i.default)('http://onlyzyx.com/static/combine/third/valine/parse.js',function(){e.initBody(),(window.MV.scriptEle=!0)},1==window.MV.scriptEle||0==t.length):(0,i.default)('http://onlyzyx.com/static/combine/third/valine/parse.min.js',function(){e.initCheck(),(window.MV.scriptInit=!0)},1==window.MV.scriptInit||0==t.length)}},function(module,exports,__webpack_require__){"use strict";var _ajax=__webpack_require__(2),_ajax2=_interopRequireDefault(_ajax);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}
