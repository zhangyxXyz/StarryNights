!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define("MiniValine",[],t):"object"==typeof exports?exports.MiniValine=t():e.MiniValine=t()}(window,(function(){window.regfunc=function(f){window['f'+f]=function(l){console.log(l)
    ...
    e.exports=function(e){var t;1<arguments.length&&void 0!==arguments[1]&&arguments[1]?(t=[],window.autosize||t.push("npm/autosize@5.0.1/dist/autosize.min.js"),window.filterXSS||t.push("npm/xss@1.0.11/dist/xss.min.js"),e.config.closeUA||window.UAParser||t.push("npm/ua-parser-js@1.0.2/dist/ua-parser.min.j"),!e.math&&void 0!==e.config.math||"undefined"!=typeof MathJax||t.push("npm/mathjax@3.2.1/es5/tex-svg.js"),!e.md&&void 0!==e.config.md||window.marked||t.push("npm/marked@1.2.0/lib/marked.min.js"),(0,i.default)("https://onlyzyx.com/static/combine/third/valine/parse.js",(function(){e.initBody(),window.MV.scriptEle=!0}),1==window.MV.scriptEle||0==t.length)):(e.config.NoRecordIP||(void 0===window.MV.ip?(0,a.default)(e):e.C.ip=window.MV.ip),t=[],window.md5||t.push("npm/blueimp-md5@2.18.0/js/md5.min.js"),window.AV||t.push("npm/leancloud-storage@4.12.2/dist/av-min.js"),(0,i.default)("https://onlyzyx.com/static/combine/third/valine/parse.min.js",(function(){e.initCheck(),window.MV.scriptInit=!0}),1==window.MV.scriptInit||0==t.length))}},function(module,exports,__webpack_require__){"use strict";var _ajax=__webpack_require__(2),_ajax2=_interopRequireDefault(_ajax);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}
